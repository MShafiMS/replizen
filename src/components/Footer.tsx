    ...
    <div className="bg-white border-t">
      <div className="relative flex justify-start md:justify-center md:items-end ">
        <img
          ...
          alt="background"
        />
        <div className="flex pt-36 md:pt-32 lg:pt-40 xl:pt-72 px-4 md:px-6  xl:px-20 flex-col justify-start items-start md:justify-center md:items-center relative z-10">
